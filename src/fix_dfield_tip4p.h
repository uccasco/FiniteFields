/* -*- c++ -*- ----------------------------------------------------------
   ...
   Modified from constant E to constant D, adding in TIP4P capability
   (2017-2019): Stephen J. Cox (University of Cambridge)
...
FixStyle(dfield/tip4p,FixDfieldTip4p)

#else

#ifndef LMP_FIX_DFIELD_TIP4P_H
#define LMP_FIX_DFIELD_TIP4P_H
...
class FixDfieldTip4p : public Fix {
 public:
  FixDfieldTip4p(class LAMMPS *, int, char **);
  ~FixDfieldTip4p();
  int setmask();
  void init();
  void setup(int);
